  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: "relative h-9 w-9 p-0 text-center text-sm focus-within:z-20 focus-within:relative [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md",
        day: cn(
